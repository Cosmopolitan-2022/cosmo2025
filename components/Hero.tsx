...
function Hero() {
 ...
 return (
  <>
    <section className="relative -mt-1 pb-[200px] pt-[50px] md:pb-[117px] flex flex-col md:flex-row items-center overflow-visible justify-center bg-[linear-gradient(90deg,#082B20_1.81%,#03523C_50.72%,#082B20_99.63%)] w-full
...
>
 ...
 <div className="relative -mt-8 w-full bg-[#03523C]">
  <Image
          src={backgroundImageUrl}
          alt="Event background"
          fill
