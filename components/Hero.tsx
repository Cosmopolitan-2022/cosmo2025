...
function Hero() {
 ...
 return (
  <>
    <section className="scroll-smooth relative -mt-1 pb-[200px] pt-[50px] md:pb-[117px] flex flex-col md:flex-row items-center overflow-visible justify-center bg-[linear-gradient(90deg,#082B20_1.81%,#03523C_50.72%,#082B20_99.63%)] w-full
