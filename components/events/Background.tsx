  ...
  return (
    <div>
        <Image
                ...
                />
                <div className="absolute inset-x-0 sm:-right-10 top-12 sm:top-10 flex justify-center sm:justify-end">
                  <Image
                    src={
                      lamp.src}
                    alt={lamp.alt}
                    ...
                    className= " w-[250px] h-[450px] sm:w-[200px] sm:h-[400px] md:w-[250px] md:h-[450px] lg:w-[450px] lg:h-[800px]"
                  />
                </div>
