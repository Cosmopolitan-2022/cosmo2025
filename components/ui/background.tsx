    ...
    <div className="relative  overflow-hidden w-full h-[1000px]"> 
      ...
      <div className="absolute inset-0 flex items-center justify-center z-0">
        <Image
          ...
          className="object-contain w-full max-w-lg sm:max-w-xl md:max-w-2xl lg:max-w-3xl xl:max-w-5xl h-[750px] lg:h-[950px] opacity-40"
        />
      </div>
      ...
      <div className="absolute top-[0px] right-[-20px] lg:right-[-80px]">
        <Image
          src={lamp.src}
          alt={lamp.alt}
          width={lamp.width}
          height={lamp.height}
          className="w-[150px] scale-x-[-1] h-[250px] lg:w-[300px] lg:h-[420px] xl:w-[350px] xl:h-[480px]"
        />
      </div>
    </div>
  );
