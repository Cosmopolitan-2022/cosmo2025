...
function Footer() {
  ...
  return (
    <div className="bg-[#03523C] ">
      <div className="pt-4 md:pt-6 px-2 md:pr-4 lg:pr-16 w-full h-max rounded-t-[48px] bg-[#FFD9A4] bg-gradient-to-b from-[#FFD9A4] to-white">
        ...
        <div className="w-full mt-2">
            <h1 className="text-center text-[8px] md:text-[10px] font-semibold uppercase   text-[#03523C]  leading-normal">  2025 © Webwiz X Cosomo. All rights reserved.</h1>
          </div>
      </div>
    </div>
  ); 
